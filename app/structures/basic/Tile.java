...
public class Tile {
	...
	boolean haveHumanUnit = false;
	
	boolean haveAiUnit = false;
	...
	public void setCanBeAttack(boolean canBeAttack) {
		this.canBeAttack = canBeAttack;
	}
	
	public boolean isHaveHumanUnit() {
		return haveHumanUnit;
	}

	public void setHaveHumanUnit(boolean haveHumanUnit) {
		this.haveHumanUnit = haveHumanUnit;
	}

	public boolean isHaveAiUnit() {
		return haveAiUnit;
	}

	public void setHaveAiUnit(boolean haveAiUnit) {
		this.haveAiUnit = haveAiUnit;
	}
	
	public boolean isTileHighLighted() {
		return tileHighLighted;
	}
	public boolean setTileHighLighted(boolean tileHightLighted) {
		return this.tileHighLighted=tileHightLighted;
	}

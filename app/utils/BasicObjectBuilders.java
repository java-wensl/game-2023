...
public class BasicObjectBuilders {
	 ...
	 * configuration file. Configuration files can be found in the conf/gameconfs
	 * directory. The card should be given a unique id number. The classtype field
	 * specifies the type of Card to be constructed, e.g. Card.class will create a
	 * default card object, but if you had a class extending card, e.g.
	 * MyAwesomeCard that extends Card, you could also specify MyAwesomeCard.class
	 * here. If using an extending class you will need to manually set any new data
	 * fields.
	 * 
	...
	/**
	 * This class produces a EffectAnimation object given a configuration file.
	 * Configuration files can be found in the conf/gameconfs directory.
	 * 
	 * @param configurationFile
	 * @return
	 */
	...
	/**
	 * Loads a unit from a configuration file. Configuration files can be found in
	 * the conf/gameconfs directory. The unit needs to be given a unique identifier
